...
if ($id <=0) {
	...
	$sql = "select jobName, jobUrgent, jobContent ,checklist from todo where id=?;"; 
...
完成/未完成:<select name="check">
<option selected value="<?php echo $rs['checklist'];?>"><?php echo $rs['checklist'];?></option>
<option value="完成">完成</option>
<option value="未完成">未完成</option>
</select> <br>

<input type='button' onClick="updataForm()" value="送出"> 
<input type='button' onClick="deleteForm()" value="刪除"> 
